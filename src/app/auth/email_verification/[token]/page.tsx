	...
	const successMarkup = (
		<>
			<div className='flex flex-wrap justify-center flex-col items-center'>
				...
				<p className='mb-3'>
					Congratulations! You have successfully verified your email address! You can login to the{' '}
					{siteMetadata.appName} platform.
				</p>
			</div>
	...
	const errorMarkup = (
		<>
			<div className='flex flex-wrap justify-center flex-col items-center p-2 rounded-2xl'>
				...
				<p className='mb-3'>
					Your email address could not be verified due to unavoidable reasons. The link may expire
					after more than ten minutes. In that case, request the verification email again by
