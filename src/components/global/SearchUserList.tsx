...
export default function SearchUserList( { onUserClick, searchKey, wrapperClassname }: Props ){
    ...
    return (
        <div
            className={ classNames( "box bg-white max-w-5xl p-3 absolute top-full left-0 w-max h-fit overflow-y-auto mt-1 bg-white drop-shadow-2xl max-h-[80vh] overflow-y-auto", wrapperClassname ) }>
